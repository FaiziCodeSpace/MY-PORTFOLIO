...
/* -------- Global Spotlight (follows mouse over the grid) -------- */
...
/* -------- Main: ExperienceMagicSlider -------- */
export default function ExperienceMagicSlider({
  slides = [
    { header: "5+ Years", text: "Experience" },
    { header: "UI/UX", text: "Expert" },
    { header: "Responsive", text: "Pages" },
    { header: "3D Effects", text: "Animations" },
  ],
  useSpotlight = true,
  glowColor = DEFAULT_GLOW_COLOR,
}) {
